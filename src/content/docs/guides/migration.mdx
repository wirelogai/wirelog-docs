...
Or use the [JS SDK](/tracking/js-sdk) for automatic `page_view` tracking, session management, and batching:

```html
<script src="https://wirelog.ai/public/wirelog.js" data-key="pk_..." data-host="https://wirelog.ai"></script>
