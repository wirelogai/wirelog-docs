...
```text
# What event types exist? What properties does each have?
inspect * | last 30d

# Deep dive into a specific event's schema
inspect signup | last 7d
```

The agent reads the inspect output to learn event names, property keys, coverage percentages, data types, and sample values. This replaces guesswork with data-driven query construction.
...
```text
# Step 1: Discover events and their properties
inspect * | last 30d
