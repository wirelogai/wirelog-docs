...
Oh, and it's cheap. 10M events free. $5 per million after. No per-seat. No "contact sales."
...
Server-side works too. Pass `user_id` explicitly in Node:
...
<CardGrid>
  <Card title="Quickstart" icon="rocket">
    Track events in 2 minutes. [Start here](/quickstart)
  </Card>
