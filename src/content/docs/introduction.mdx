...
Track what users do. Let LLM agents query the data, find insights, and tell you what to fix. WireLog stays query-first for agents and dashboard-first in the authenticated project workspace. Agents sync source-controlled YAML dashboards; humans get a first-party shared view without a visual builder or public sharing layer.
