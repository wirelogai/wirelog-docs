...
Track what users do. Let LLM agents query the data, find insights, and tell you what to fix. WireLog is query-first, not dashboard-first; your agent is the analyst. When humans need a shared view, agents can sync source-controlled YAML dashboards into the authenticated project page.
