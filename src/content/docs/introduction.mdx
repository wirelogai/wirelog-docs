...
Track what users do. Let LLM agents query the data, find insights, and tell you what to fix. WireLog is query-first, not dashboard-first; your agent is the analyst. When you need a shared view, agents can author lightweight YAML dashboards from the same queries.
